...
RSpec.describe VotesController, type: :controller do
  ...
  context "signed in user" do
    ...
    describe "POST up_vote" do
      ...
      # up voting a post will increase the number of points on the post by one.
...
# redirected back to the correct view (posts show or topics show) depending on which view they up voted from.
